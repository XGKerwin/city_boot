...
public class CinemaImpl extends ServiceImpl<MovieInfoMapper, MovieInfo> implements MovieInfoService {
    ...
    public List<MovieStatus> queryStatus(String userid ,String movieid,String status) {
    ...
    public List<MovieSession> querySessionById(String movieid) {
